...
![會議室即時演示：AI 員工在像素辦公室裡開會](.github/assets/demo.gif)
...
第一次執行會自動：安裝依賴（1–3 分鐘）→ 建置網頁介面 → 建立**預設團隊（12 位 AI
...
| 沈昀 | UI/UX 與前端工程師 | 介面設計、可用性、前端架構 |
| 高梓睿 | 資料庫與後端工程師 | 資料模型、API 設計、系統效能 |
| 唐立言 | AI 架構設計師 | RAG／代理架構、模型選型、AI 產品化 |
